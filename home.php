...
<html>
	...
	<head>
		<title>Welcome  To Campus Corner - Sign up, Log in, Post </title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Campus Corner"><b>Campus Corner</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
...
<li><a href="chatbot/chatbot.php" title="Chat"><label>CHAT</label></a></li>
...
<?php
	include("includes/database.php");
			$query=mysqli_query($con,"SELECT * from user where user_id='$id' order by user_id DESC") or die(mySQL_error());
...
<?php
	include("includes/database.php");
			$query=mysqli_query($con,"SELECT * from post LEFT JOIN user on user.user_id = post.user_id order by post_id DESC") or die(mysqli_error());
			while($row=mysqli_fetch_array($query)){
